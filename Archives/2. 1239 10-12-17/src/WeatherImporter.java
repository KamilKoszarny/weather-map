...
public class WeatherImporter {
    ...
    final int[] CITIES_ID_LIST = new int[16];

    public WeatherImporter() {
    ...
    private void importCityData(City city, int id) throws IOException {
        URL url = new URL("https://pogoda.interia.pl/prognoza-szczegolowa-xxx,cId," + CITIES_ID_LIST[id]);
